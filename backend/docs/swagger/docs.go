    ...
    "paths": {
        ...
        "/user/nodes/{node_id}": {
            "post": {
                ...
                "responses": {
                    "202": {
                        "description": "Node reservation in progress",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/app.APIResponse"
        ...
        "/user/register/verify": {
            "post": {
                ...
                "responses": {
                    "202": {
                        "description": "workflow_id: string, email: string, token_pair: object",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/app.APIResponse"
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/app.UserWorkflowsResponse"
                                        }
                                    }
                                }
                            ]
