    ...
    <div class="edit-node-modal">
      ...
      <v-form ref="formRef" @submit.prevent="onSave" v-model="isFormValid">
        <div class="modal-fields">
          ...
          <v-switch hide-details v-model="localNode.fullCapabilities" inset color="primary" label="Use Full Node Capabilities" />
          
          <v-expand-transition>
            <div v-if="!localNode.fullCapabilities">
              <label>vCPU</label>
              <v-text-field
          ...
          <div class="ssh-key-section" style="margin-top: 1.5rem">
            ...
            <v-chip-group v-model="selectedSshKeyIds" :multiple="true" column>
              <v-chip
...
const nameRules = computed(() => [createUniqueNodeNameRule(props.existingNames, props.node.name)])
